...
**Serpent** (Python-like) <br>
**LLL** (Lisp-like) <br>
**Mutan** (Go-based) <br>
**Viper** (a strongly-typed Python-derived language) <br>
**Solidity** (Javascript-like). <br>
...
## Summary
 <br>
[remix-alpha.ethereum.org/](https://remix-alpha.ethereum.org/) <br>
